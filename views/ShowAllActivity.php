    ...
    <header>		
     ...
     <h1 style="color: red;" align="center">活動</h1>
        <table border="1" align="center" cellpadding="5" cellspacing="0" bgcolor="#000000">
          <tr>
            <td colspan="8" align="center" bgcolor="#77FF00"><font color="#000000">活動資訊</font></td>
          </tr>
          <tr>
            <td height="30" width="60" align="center" valign="baseline" bgcolor="#FFFFFF"><font color="#000000">編號</font></td>
            <td height="30" align="center" valign="baseline" bgcolor="#FFFFFF"><font color="#000000">活動名稱</font></td>
            <td height="30" width="70" align="center" valign="baseline" bgcolor="#FFFFFF"><font color="#000000">總人數</font></td>
            <td height="30" width="70" align="center" valign="baseline" bgcolor="#FFFFFF"><font color="#000000">攜伴</font></td>
            ...
            <td height="30" width="80" align="center" valign="baseline" bgcolor="#FFFFFF"><font color="#000000">目前報名人數</font></td>
          ...
          ?>
          <tr>
            <td height="30" align="center" valign="baseline" bgcolor="#FFFFFF"><font color="#000000"><?= $row['id'] ?></font></td>
            ...
            <td height="30" align="center" valign="baseline" bgcolor="#FFFFFF"><font color="#000000"><?= $row['JoinNumber'] ?></font></td>

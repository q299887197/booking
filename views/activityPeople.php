  ...
  <body>
    ...
    <div class="col-md-4">
     <h1 style="color: red;" align="center">Activity</h1>
          ...
          <tr>
            ...
            <td valign="baseline" bgcolor="#FFFFFF"><input type="text" name="StartTime" id="StartTime" value="" style= "color:#000000" /></td>
          </tr>
          <tr>
            <td width="80" align="center" valign="baseline" bgcolor="#FFFFFF"><font color="#000000">截止報名 時間</font></td>
            <td valign="baseline" bgcolor="#FFFFFF"><input type="text" name="EndTime" id="EndTime" value="" style= "color:#000000" /></td>
          </tr>
        </table>
    </div>
    ...
    <div class="col-md-6">
     <h1 style="color: red;" align="center">New Activity</h1>
      <form id="form2" name="form2" method="post" action="<?= $root ?>/New/NewActivity">
        <table width="320" border="1" align="center" cellpadding="5" cellspacing="0" bgcolor="#000000">
          <tr>
            <td colspan="2" align="center" bgcolor="#77FF00"><font color="#000000">建立活動報名</font></td>
          </tr>
